  ...
  <div>
    <nav class="navbar navbar-light bg-light">
      <div class="d-flex">
        ...
        <span class="navbar-text" contenteditable="true"
          >{{ user.username }}
        </span>
        <span class="navbar-text separator"> - </span>
        <span class="navbar-text" contenteditable="true">
      ...
      <button class="btn btn-success" @click="createUser()">Ajouter utilisateur</button>
      <button class="btn btn-warning" @click="updateUser()">Modifier l'utilisateur</button>
